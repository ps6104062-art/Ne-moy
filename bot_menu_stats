...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        "Привет! Ищу TON-адреса с нужным окончанием.\n\n"
        "Напиши паттерн (до 8 символов) — начну поиск.\n"
        "Пример: MOON\n\n"
        "— Команды —\n"
        "/settings — текущие настройки\n"
        "/seed12 — сид 12 слов\n"
        "/seed24 — сид 24 слова (TON)\n"
        "/caseon — учитывать регистр\n"
        "/caseoff — игнорировать регистр\n"
        "/addruq — формат UQ... (non-bounceable)\n"
        "/addreq — формат EQ... (bounceable)\n"
